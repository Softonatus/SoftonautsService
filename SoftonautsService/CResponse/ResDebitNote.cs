...
namespace SoftonautsService.CResponse
{
    ...
    public class ResDebitNote
    {
        ...
        [DataMember]
        public List<ResDebitItem> ResDebitItemList
        { get; set; }

    }

    [DataContract]
    public class ResDebitNoteGet : ResCommon
    {
        [DataMember]
        public int? DebitId
        { get; set; }
    ...
    [DataContract]
    public class ResDebitNoteGetList
    {
        [DataMember]
        public List<ResDebitNoteGet> resDebitNoteGet
        {
            get;
            set;
        }
